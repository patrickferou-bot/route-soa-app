...
- "lat" / "lon" : PRIORITÉ ABSOLUE — le bon de chargement contient les coordonnées GPS EXACTES du point de livraison (silo, pas adresse de facturation). Cherche-les dans la colonne GPS ou coordonnées du bon et recopie-les EXACTEMENT. Ces coordonnées pointent vers le silo réel sur l'exploitation du client — elles sont plus fiables que tout géocodage d'adresse. Ne les invente JAMAIS, ne les estime JAMAIS : si elles sont présentes dans le PDF, extrais-les. Si absentes, mets null.
